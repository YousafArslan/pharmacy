...
export const MedicineCategoryHomeTab = [
  {
    ...
    image: (
      <Image
        style={Style.imagsetstylefoodyitemdata}
        resizeMode="cover"
  ...
  },
  {
    ...
    image: (
      <Image
        style={Style.imagsetstylefoodyitemdata}
        resizeMode="cover"
        source={images.Baby_care_imag_five}
      />
    ),
    text: 'Ayurveda',
  },
...
export const orderlist = [
  ...
  },
  {
    ...
    price: '150',
    paregraphtetx:
      'Ascoril LS Syrup is a combination medicine used in the treatment of cough with mucus. It thins mucus in the nose, windpipe, and lungs, making it easier to cough out.',
  },
  {
    id: 4,
    image: (
...
export const Foodsdetaileslistingpage = [
  {
    ...
    rupistext: '125',
    fireicon: (
      <IconA name="local-fire-department" color={'#E89528'} size={16} />
    ),
    onefortycal: '145 cal',
    paregrapgtext:
      'Left over Pharmacy and supplies are gathered and sold for 50% off!',
  },
  {
    id: 2,
...
export const yourorderdata = [
  ...
  },
  {
    ...
    price: '420.00',
    items: 'ITEMS',
    onevx: 'Omnacortil Oral Solution',
    orderontext: 'ORDERED ON',
